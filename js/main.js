let loginEmailInput = document.getElementById("firstEmail");
let loginPasswordInput = document.getElementById("firstPass");
let loginBtn = document.getElementById("loginBtn");
let signupAnchor = document.getElementById("signUp");
